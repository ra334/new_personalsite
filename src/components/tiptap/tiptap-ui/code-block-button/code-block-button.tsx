...
// --- Tiptap UI ---
import type { UseCodeBlockConfig } from '@src/components/tiptap/tiptap-ui/code-block-button/use-code-block'
import {
    CODE_BLOCK_SHORTCUT_KEY,
    useCodeBlock,
} from '@src/components/tiptap/tiptap-ui/code-block-button/use-code-block'
// --- Hooks ---
